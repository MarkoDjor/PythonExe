#Ispod je dat recnik (dictionary) koji se zove ghostlyd. Odstampaj na ekranu liniju po liniju keys i values ovog recnika, u formatu: kljuc: "key" , vrednost: "value". Ispod je primer konkretnih linija (prvih 6) koje treba da se odstampaju na ekranu:
#kljuc: "A" , vrednost: "A is for Alfred, poisoned to death."
#kljuc: "B" , vrednost: "B is for Bertrand, consumed by meth."
#kljuc: "C" , vrednost: "C is for Cornell, who ate some glass."
#kljuc: "D" , vrednost: "D is for Donald, who died from gas."
#kljuc: "E" , vrednost: "E is for Edward, hanged by the neck."
#kljuc: "F" , vrednost: "F is for Freddy, crushed in a wreck."
