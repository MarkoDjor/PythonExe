#Ispod je dat recnik (dictionary) koji se zove ghostlyd . Cilj ovg zadatka je da se korisnik uplasi, dakle da se od korisnika trazi da unese neku (bilo koju) recenicu odnosno tekst. Na to program treba da izdvoji prvo slovo unesenog teksta i da ga pretvori (ako vec nije) u veliko slovo. Zatim treba da se proveri da li to veliko slovo postoji kao key u dictionary-ju. Ako postoji recnica koja odkovara tom kljucu treba da se odstampa. Primera radi ako korisnik unese "danas je cetvrtak" na ekranu treba da se odstampa "D is for Donald, who died from gas.". Sa druge strane ako se unese teskt "1 je najmanji ceo broj", treba da se odstampa: "Prvo slovo unetog teksta ne postoji kao kljuc u recniku".
