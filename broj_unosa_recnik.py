#Ispod je dat recnik (dictionary) koji se zove ghostlyd. Odredi u okviru programa broj unosa u tom recniku i odstampaj taj broj na ekranu. Konkretno za ghostlyd program treba  da odstampa
